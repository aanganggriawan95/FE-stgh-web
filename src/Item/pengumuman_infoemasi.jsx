...
export default function PengumumanInformasi() {
  ...
  const productTemplate = (info) => {
    return (
      <div className="surface-border text-center h-[300px] relative ">
        <img
          src={info.foto}
          alt="Foto Pengumuman"
          className="shadow-2 absolute w-full h-full z-[-1]"
        />
        <div className="flex border items-center justify-center h-full w-full">
          <div className="z-10">
